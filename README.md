...
2012-11-15
=====================================
接下来要完成人物移动问题、是否加入重力加速度以控制其移动 ，技能模块（技能分 独立技能： 具备独立碰撞体积、独立的绘制方式、独立的生命周期和附着技能: 以人物自身为碰撞体积 2种），
2012-11-19
======================================
接下来要完成技能的释放，碰撞这2块，
2012-11-22 总结
=============================
此游戏开发到此告一段落，与预期的效果还是相差很大，花了近一个月的时间，
用一门不熟悉的语言来开发还是要深思之后再做，对于学习javascript这种脚本语言还是要练习和看他人
的好的代码，尽量能学习市面上已有的成熟的框架中使用的技术。
整个项目，写的不好，并没有完成符合MVC的思想，也没有用到比较好的模式
这次练习总的来说还可以，自己打分 6/10。及格吧 : )
